...
final class PageRenderer
{
    ...
    private function render_filtered_template(callable $callback): void
    {
        ...
        if (is_string($html) && $html !== '') {
            echo $this->filter_alternate_links($html); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Full theme output is filtered, not generated by this plugin.
        }
    }
